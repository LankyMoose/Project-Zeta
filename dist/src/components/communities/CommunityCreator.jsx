...
export const CommunityCreator = () => {
    ...
    return (<Modal onclose={onModalClose} visible={communityCreatorModalOpen} toggle={() => (communityCreatorModalOpen.value = !communityCreatorModalOpen.value)}>
      <ModalHeader>
      ...
      <ModalBody>
        <form onsubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input type="text" id="title" oninput={handleChange} watch={state} bind:value={() => state.value.title}/>
          </div>

          <div className="form-group">
            <label htmlFor="description">Description</label>
            <textarea id="description" oninput={handleChange} watch={state} bind:value={() => state.value.description}></textarea>
          </div>
          <div className="form-group">
            <Button type="submit" className="btn btn-primary hover-animate" watch={[loading, state]} bind:disabled={() => loading.value ||
