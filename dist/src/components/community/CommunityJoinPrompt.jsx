...
export const CommunityJoinPrompt = () => {
    ...
    return (<Modal toggle={() => (communityJoinModalOpen.value = false)} visible={communityJoinModalOpen}>
      <ModalHeader>
      ...
      <ModalBody>
        <div className="flex flex-column gap">
          ...
          <div className="flex gap justify-content-between">
            <Button watch={loading} bind:disabled={() => loading.value} onclick={() => (communityJoinModalOpen.value = false)} className="btn btn-secondary hover-animate">
              Cancel
            </Button>
            <Button watch={loading} bind:disabled={() => loading.value} onclick={join} className="btn btn-primary hover-animate">
              Join
