...
export const CommunityLeaveConfirmation = () => {
    ...
    return (<Modal toggle={() => (communityLeaveModalOpen.value = false)} visible={communityLeaveModalOpen}>
      <ModalHeader>
      ...
      <ModalFooter>
        <Button type="button" className="btn btn-secondary hover-animate" watch={loading} bind:disabled={() => loading.value} onclick={() => (communityLeaveModalOpen.value = false)}>
          Cancel
        </Button>
        <Button type="button" className="btn btn-danger hover-animate" watch={loading} bind:disabled={() => loading.value} onclick={leave}>
          Leave
