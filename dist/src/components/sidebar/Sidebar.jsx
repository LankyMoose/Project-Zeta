...
export const Sidebar = () => {
    return (<>
      <Transition className="sidebar-background" properties={[{ name: "opacity", from: "0", to: "1", ms: 300 }]} watch={sidebarOpen} bind:visible={() => sidebarOpen.value} onclick={() => (sidebarOpen.value = false)}/>
      <SlideInOut settings={{ from: "left" }} className="sidebar-container" watch={sidebarOpen} bind:visible={() => sidebarOpen.value}>
