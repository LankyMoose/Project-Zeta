...
export const CommunityFixedHeader = () => {
    ...
    return (<div onMounted={onMounted} onUnmounted={onUnmounted}>
      <SlideInOut className="community-page-fixed-title flex justify-content-between align-items-center" settings={{ from: "top" }} watch={hasScrolled} bind:visible={() => hasScrolled.value}>
